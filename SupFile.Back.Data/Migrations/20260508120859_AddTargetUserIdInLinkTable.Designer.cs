...
namespace SupFile.Back.Data.Migrations
{
    ...
    [Migration("20260508120859_AddTargetUserIdInLinkTable")]
    partial class AddTargetUserIdInLinkTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SupFile.Back.Core.Entities.Link", b =>
                {
                    ...
                    b.HasOne("SupFile.Back.Core.Entities.Auth.ApplicationUser", "TargetUser")
                        .WithMany()
